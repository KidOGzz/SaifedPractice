 ...
 * have elo, etc.
 */
// This class purposely uses ogLib Gson (as we want to actualy serialize
...
public final class KitType {
    ...
    static {
        ...
        collection.find().iterator().forEachRemaining(doc -> {
            allTypes.add(ogLib.PLAIN_GSON.fromJson(doc.toJson(), KitType.class));
        });
    ...
    public void saveAsync() {
        Bukkit.getScheduler().runTaskAsynchronously(PotPvPSI.getInstance(), () -> {
            MongoCollection<Document> collection = MongoUtils.getCollection(MONGO_COLLECTION_NAME);
            Document kitTypeDoc = Document.parse(ogLib.PLAIN_GSON.toJson(this));
